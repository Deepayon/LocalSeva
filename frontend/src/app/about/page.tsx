...
export default function AboutPage() {
  ...
  const values = [
    {
      ...
      title: "Trust & Safety",
      description:
        "We prioritize community safety with verified profiles and secure transactions.",
    },
    {
      icon: Safe.Handshake,
      title: "Community First",
      description:
        "Building stronger neighborhoods through mutual support and collaboration.",
    },
    {
      icon: Safe.Lightbulb,
      title: "Innovation",
      description:
        "Leveraging technology to solve real community problems efficiently.",
    },
    {
      icon: Safe.Globe,
      title: "Sustainability",
      description:
        "Promoting eco-friendly practices and resource sharing within communities.",
    },
  ];
  ...
  const timeline = [
    ...
    },
    {
      ...
      title: "Beta Launch",
      description:
        "Launched in Bangalore with 5 core services and 10 pilot neighborhoods.",
    },
    {
      year: "2024",
      title: "Rapid Growth",
    ...
    },
    {
      ...
      title: "Future Vision",
      description:
        "Planning to launch AI-powered features and expand to international markets.",
    },
  ];
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
            ...
            to share services, information, and resources.
          </p>
          <div className="flex justify-center space-x-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-orange-500 hover:border-orange-500"
            >
              Learn More
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                We're building more than just an app – we're creating a movement
                towards more connected, sustainable, and supportive urban
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              These principles guide everything we do and shape the future of
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From a simple idea to a nationwide movement, here's our story of
              growth and impact.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Passionate individuals committed to building stronger communities
              across India.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Facilitated over ₹5 crore in community transactions,
                      supporting local economies and creating income
                      opportunities.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Helped community members save over 100,000 hours through
                      efficient service exchanges and information sharing.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Strengthened neighborhood bonds with over 50,000 positive
                      interactions and mutual support exchanges.
                    </p>
                  </div>
                </div>
              </div>
