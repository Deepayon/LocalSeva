...
export default function AboutPage() {
  const stats = [
    ...
    { icon: MapPin, label: "Neighborhoods", value: "500+" },
    { icon: Building, label: "Cities", value: "25+" },
    { icon: Heart, label: "Services Exchanged", value: "100,000+" }
  ];
            ...
            <div className="relative">
              <div className="bg-orange-100 rounded-lg p-8 h-96 flex items-center justify-center">
                <div className="text-center">
                  <Heart className="h-24 w-24 text-orange-500 mx-auto mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg p-8 h-96 flex items-center justify-center">
              <div className="text-center">
                <Star className="h-24 w-24 text-orange-500 mx-auto mb-4" />
